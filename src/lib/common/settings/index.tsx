            ...
            sub: {
                            ...
                            widgets: [
                                {
                                    ...
                                    content: [
                                        ...
                                        ReturnType<typeof themeType.get>
                                    >[],
                                    init() {
                ...
                "page-extension": {
                    ...
                    content: {
                        ...
                        keyof ReturnType<typeof pageExtension.get>,
                        SettingContent
                    >,
                },
                            ...
                            widgets: [
                                {
                                    type: "textarea",
                                    placeHolder:
                                        "写入字体名，以换行分隔。若需要中英文混排，需将英文字体写在中文字体之前。",
                                    init() {
        ...
        modules: {
            ...
            sub: _(await loadUserModules())
                ...
                .map((entry) => {
                    ...
                    } satisfies SubSettingKey;
                })
                .keyBy("name")
                .value() satisfies MainSettingKey["sub"],
        },
            ...
            sub: {
                experimental: {
                    ...
                    content: {
                            ...
                            widgets: [
                                {
                                    ...
                                    event() {
                                        experimental.merge({
                                            moreBlurEffect:
                                                !experimental.get().moreBlurEffect,
                                        });
                                    },
                                },
                            ],
                        ...
                        keyof ReturnType<typeof experimental.get>,
                        SettingContent
                    >,
                },
