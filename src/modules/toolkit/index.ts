            ...
            widgets: [
                {
                    ...
                    event() {
                        toolkitToggles.merge({
                            autoExpand: !toolkitToggles.get().autoExpand,
                        });
                    },
                },
            ],
            ...
            widgets: [
                {
                    ...
                    event() {
                        toolkitToggles.merge({
                            reloadAvatars: !toolkitToggles.get().reloadAvatars,
                        });
                    },
                },
            ],
                ...
                _.forEach(entries, (entry) => {
                    if (entry.isIntersecting) {
                        ...
                        if (avatar.naturalWidth > 0) {
                            ...
                            const portarit = JSON.parse(
                                dataField.replaceAll(/'/g, '"'),
                            ).id;
